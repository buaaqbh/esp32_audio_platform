...
static void bt_av_hdl_a2d_evt(uint16_t event, void *p_param)
{
    ...
    case ESP_A2D_CONNECTION_STATE_EVT: {
        ...
        bt_state.connection_state = a2d->conn_stat.state;
    ...
    case ESP_A2D_AUDIO_STATE_EVT: {
        ...
        bt_state.audio_state = a2d->audio_stat.state;
    ...
    case ESP_A2D_AUDIO_CFG_EVT: {
        a2d = (esp_a2d_cb_param_t *)(p_param);
        bt_state.codec_type = a2d->audio_cfg.mcc.type;
        ...
        if (a2d->audio_cfg.mcc.type == ESP_A2D_MCT_SBC) {
            ...
            if (sbc0 & 0x80)
                bt_state.sample_rate = 16000;
            if (sbc0 & 0x40)
                bt_state.sample_rate = 32000;
            if (sbc0 & 0x20)
                bt_state.sample_rate = 44100;
            if (sbc0 & 0x10)
                bt_state.sample_rate = 48000;
        }
        break;
    }
    default:
